...
--- a/app/page.tsx
+++ b/app/page.tsx
@@ -21,171 +21,208 @@ export default function JEEChallengerUltimate() {
...
@@ -225,160 +262,169 @@ export default function JEEChallengerUltimate() {
         {screen === 'auth' && (
...
@@ -404,26 +450,26 @@ export default function JEEChallengerUltimate() {
           </div>
         )}
